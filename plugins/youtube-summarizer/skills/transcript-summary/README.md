...
This skill takes a transcript file path (or inline text) and produces a consistent, structured summary. It is fully independent — no dependency on sibling skills. Use `/youtube-get-transcript` separately to obtain a transcript file, then pass the file path to this skill.
...
./scripts/summary.sh "/tmp/youtube-get-transcripts/dQw4w9WgXcQ.en.txt"

# Typical workflow in Claude Code
# Step 1: Download transcript
/youtube-get-transcript https://www.youtube.com/watch?v=xxx
...
| `File not found: <path>` | File does not exist | Check the file path; run `/youtube-get-transcript` first |
